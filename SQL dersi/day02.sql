...
select * from kelimler where regexp_like (kelime, 'ot|at','i');
select * from kelimler where regexp_like (kelime, 'ot|at');
-- i kllanmmaıza gerek yok default olarak i var zaten 
...
select * from kelimler where regexp_like (kelime, '^ho|hi');
select * from kelimler where regexp_like (kelime, '^ho|^hi');
...
select * from kelimeler where regexp_like(kelime,'^s|^b[a-zA-Z0-9]l[a-zA-Z0-9][a-zA-Z0-9]','c');
