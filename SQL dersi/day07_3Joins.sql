...
select sirket_isim,siparis_id,siparis_tarihi ,B.sirket_id from sirketler as A
...
-- sirketler tablosu = A
-- siparisler tablosu = B
select siparis_id , siparis_tarihi,sirket_isim from siparisler as B
left join sirketler as A
on A.sirket_id=B.sirket_id;

select siparis_id , siparis_tarihi,sirket_isim from sirketler as A
